...
**Muffler** is a lightweight, zero-configuration browser extension that automatically balances your audio workspace. It checks active window transitions, safely ducking background media tabs down to 25% volume and restoring your target tab back to its full custom baseline the moment you click it.<br>
